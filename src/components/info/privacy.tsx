...
const Privacy = () => {
  return (
    <div id={styles.TermsPrivacy}>
      ...
      <p>
        Your privacy is important to us. It is <strong>Iora Chain's</strong>
        policy to respect your privacy regarding any information we may collect
        from you across our website,&nbsp;
        <a href="https://iorachain.com">Iora Chain</a>, and other sites we own
        and operate.
      </p>
      <p>
      ...
      <h2>
        <strong>Cookie Policy</strong> for <strong>Iora Chain</strong>
      </h2>
      <p>
        This is the Cookie Policy for <strong>Iora Chain</strong>, accessible
        from URL
      </p>
      ...
      <ul>
        <li>
          Account related cookies If you create an account with us then we will
        ...
        <li>
          ...
          single time you visit a new page. These cookies are typically removed
        ...
        <li>
          ...
          already registered and whether to show certain notifications which
          might only be valid to subscribed/unsubscribed users.
        </li>
        <li>
          Orders processing related cookies This site offers e-commerce or
          payment facilities and some cookies are essential to ensure that your
        ...
        <li>
          ...
          questionnaires to provide you with interesting insights, helpful
      ...
      <ul>
        ...
        <li>
          ...
          cookies simply allow us to see if our customers have come to the site
          through one of our partner sites so that we can credit them
      ...
      <p>
        This policy is effective as of <strong>February</strong>
        <strong> 2022</strong>.
      </p>
    </div>
  );
